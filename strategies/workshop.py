...
class WorkshopKPIStrategy(KPIStrategy):
    ...
    def render_detail(self, data_context):
        return dmc.Text("Detalle de métrica de mantenimiento.", size="sm", c=SemanticColors.TEXT_MUTED)
...
class WorkshopGaugeStrategy(KPIStrategy):
    ...
    def render_detail(self, data_context):
        return dmc.Text("Análisis de eficiencia de mantenimiento.", size="sm", c=SemanticColors.TEXT_MUTED)
