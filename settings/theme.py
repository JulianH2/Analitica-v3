...
class DesignSystem:
    ...
    CHART_COLORS = [BRAND[5], SUCCESS[5], WARNING[5], DANGER[5], SLATE[5], INFO[5]]
...
class SemanticColors:
    ...
    PROFIT = DesignSystem.BRAND[5]
    TEXT_MAIN = DesignSystem.SLATE[8]
    TEXT_MUTED = DesignSystem.SLATE[5]
