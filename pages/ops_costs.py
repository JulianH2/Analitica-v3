...
def layout():
    ...
    def cost_block(title, value, var, color="green"):
        return dmc.Paper(p="xs", withBorder=True, bg=f"{color}.0", children=[
            dmc.Text(title, size="10px", c="dimmed", fw=700, tt="uppercase"),
            dmc.Text(value, size="sm", fw=700),
            dmc.Badge(var, size="xs", color=color, variant="light")
        ])
    ...
    return dmc.Container(fluid=True, children=[
            ...
            dmc.GridCol(span={"base": 12, "md": 4}, children=[
                dmc.SimpleGrid(cols=2, spacing="sm", children=[
                    dmc.Paper(p="md", withBorder=True, shadow="sm", children=[
                        dmc.Text("Utilidad Viaje", size="xs", c="dimmed"), dmc.Text("18.19%", fw=700, size="xl", c="blue")
                    ]),
                    dmc.Paper(p="md", withBorder=True, shadow="sm", children=[
                        dmc.Text("Costo Viaje Total", size="xs", c="dimmed"), dmc.Text("$17.1M", fw=700, size="xl", c="red")
                    ])
                ])
            ]),
        ...
        dmc.SimpleGrid(cols={"base": 1, "md": 2}, spacing="lg", mb="lg", children=[
        ...
        dmc.Paper(withBorder=True, shadow="sm", p="xs", children=[
            dmc.Tabs(value="ruta", color="teal", variant="outline", children=[
                ...
                dmc.TabsPanel(value="ruta", children=[
                     dmc.Table(
                        striped=True, highlightOnHover=True, fz="xs", mt="xs",
                        children=[
                            dmc.TableThead(dmc.TableTr([dmc.TableTh("No."), dmc.TableTh("Ruta"), dmc.TableTh("Flete"), dmc.TableTh("Costo"), dmc.TableTh("Utilidad")])),
                            dmc.TableTbody([
                                dmc.TableTr([dmc.TableTd("261"), dmc.TableTd("3T-LYCRA"), dmc.TableTd("$247k"), dmc.TableTd("$198k"), dmc.TableTd("$48k", c="green", fw=700)]),
                                dmc.TableTr([dmc.TableTd("355"), dmc.TableTd("APAXCO"), dmc.TableTd("$150k"), dmc.TableTd("$140k"), dmc.TableTd("$10k", c="green", fw=700)])
                            ])
                        ]
                    )
                ])
