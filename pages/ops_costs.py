...
chart_cost_yearly_comp = ChartWidget("cc_comp", OpsComparisonStrategy("Costo Viaje Total 2025 vs 2024", "comparativa_costos", "red", section="costos"))
    ...
    return dmc.Container(fluid=True, children=[
        ...
        dmc.Paper(p="md", withBorder=True, children=[
            dmc.Tabs(value="ruta", children=[
                ...
                # CAMBIO: dimmed -> gray
                dmc.TabsPanel(dmc.Text("Seleccione unidad...", py="xl", ta="center", c="gray"), value="unidad"),
                dmc.TabsPanel(dmc.Text("Seleccione operador...", py="xl", ta="center", c="gray"), value="operador"),
                dmc.TabsPanel(dmc.Text("Seleccione viaje...", py="xl", ta="center", c="gray"), value="viaje"),
                dmc.TabsPanel(dmc.Text("Seleccione cliente...", py="xl", ta="center", c="gray"), value="cliente"),
            ])
        ]),
        dmc.Space(h=50)
    ])
