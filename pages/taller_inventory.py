...
w_his = SmartWidget("wi_his", AdminRichKPIStrategy("almacen", "valorizacion_historica", "Valorización Histórica", "tabler:history", "indigo", sub_section="indicadores"))

w_cumpl = SmartWidget("wi_cumpl", AdminRichKPIStrategy("almacen", "cumplimiento", "Cumplimiento Max Min", "tabler:checkup-list", "green", sub_section="indicadores"))
...
w_con = SmartWidget("wi_con", AdminRichKPIStrategy("almacen", "con_existencia", "Con Existencia", "tabler:package", "indigo", sub_section="indicadores"))
...
gauge_actual = ChartWidget("gi_actual", InventoryGaugeStrategy("Valorización Actual", "valorizacion_actual", "indigo"))
    ...
    return dmc.Container(fluid=True, children=[
        ...
        dmc.Paper(p="md", withBorder=True, mb="xl", children=[
            dmc.Grid(align="center", gutter="xs", children=[
                ...
                dmc.GridCol(span=0.3, children=[dmc.Text("+", fw="bold", size="xl", ta="center")]), 
                dmc.GridCol(span=2.2, children=[w_ent.render(ctx)]), 
                dmc.GridCol(span=0.3, children=[dmc.Text("-", fw="bold", size="xl", ta="center")]), 
        ...
        dmc.Grid(gutter="lg", mb="xl", children=[# type: ignore
