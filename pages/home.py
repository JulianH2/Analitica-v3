...
def _render_home_body(ctx):
    ...
    return html.Div([
        ...
        html.Div(
            ...
            children=[
                _card(w_income.render(ctx, theme=theme)),
                _card(w_costs.render(ctx, theme=theme)),
                _card(w_margin.render(ctx, theme=theme)),
                _card(w_bank.render(ctx, theme=theme))
            ]
        ),
        ...
        dmc.Grid(
            ...
            children=[
                dmc.GridCol(
                    ...
                    children=[_card(w_main_chart.render(ctx, theme=theme))]
                ),
                dmc.GridCol(
                    ...
                    children=[
                        html.Div(
                            ...
                            children=[
                                _card(w_yield.render(ctx, theme=theme)),
                                _card(w_km.render(ctx, theme=theme)),
                                _card(w_liters.render(ctx, theme=theme)),
                                _card(w_cvkm.render(ctx, theme=theme)),
                                _card(w_cmkm.render(ctx, theme=theme)),
                                _card(w_viajes.render(ctx, theme=theme)),
                                _card(w_units.render(ctx, theme=theme)),
                                _card(w_clients.render(ctx, theme=theme))
                            ]
                        )
                    ]
                )
        ...
        html.Div(
            ...
            children=[
                _card(w_total_mtto.render(ctx, theme=theme)),
                _card(w_mi.render(ctx, theme=theme)),
                _card(w_me.render(ctx, theme=theme)),
                _card(w_ml.render(ctx, theme=theme))
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                truck_visual,
                _card(w_port.render(ctx, theme=theme)),
                _card(w_supp.render(ctx, theme=theme))
            ]
        ),
...
WIDGET_REGISTRY = {
    ...
    "h_yld": w_yield, "h_km": w_km, "h_lit": w_liters, "h_cvkm": w_cvkm,
    "h_cmkm": w_cmkm, "h_via": w_viajes, "h_uni": w_units, "h_cli": w_clients,
    "h_mi": w_mi, "h_me": w_me, "h_ml": w_ml, "h_mt": w_total_mtto,
    "h_chart": w_main_chart, "h_port": w_port, "h_supp": w_supp
}
