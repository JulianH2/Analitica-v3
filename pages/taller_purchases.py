...
# --- INDICADORES CLAVE ---
kpi_purch_total = SmartWidget("wk_total", AdminRichKPIStrategy("compras", "total", "Compras Totales", "tabler:shopping-cart", "blue"))
kpi_purch_diesel = SmartWidget("wk_diesel", AdminRichKPIStrategy("compras", "diesel", "Combustible", "tabler:gas-station", "red"))
kpi_purch_stock = SmartWidget("wk_stock", AdminRichKPIStrategy("compras", "stock", "Stock / No Stock", "tabler:box", "indigo"))
...
def layout():
    ...
    return dmc.Container(fluid=True, children=[
        ...
        dmc.Text("INDICADORES DE COMPRAS", fw="bold", mb="md", size="sm", c="dimmed"),
        ...
        dmc.Grid(gutter="lg", mb="xl", children=[
            dmc.GridCol(span={"base": 12, "md": 5}, children=[chart_purch_area.render(ctx)]),
            dmc.GridCol(span={"base": 12, "md": 3}, children=[chart_purch_type.render(ctx)]),
        ...
        dmc.Paper(p="md", withBorder=True, children=[
            dmc.Tabs(value="orders", children=[
                ...
                dmc.TabsPanel(dmc.Text("Seleccione una orden para ver el detalle de insumos...", size="sm", c="dimmed", ta="center", py="xl"), value="items")
            ])
        ]),
        dmc.Space(h=50)
    ])
