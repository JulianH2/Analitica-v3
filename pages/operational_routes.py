...
ADDITIONAL_FILTERS = [
    {"id": "route-d_viaje__ind_cargado", "label": "Vista", "type": "segmented", "data": [{"label": "Vacíos", "value": "0"}, {"label": "Cargados", "value": "1"}], "value": "0"},
    {"id": "route-foranea", "label": "Foránea", "type": "select", "data": ["Todas", "Sí", "No"], "value": "Todas"},
    ...
    return html.Div([
        ...
        dmc.Paper(
            ...
            children=[
                ...
                dcc.Graph(figure=c_map.strategy.get_figure(ctx, theme=theme), style={"height": "650px"}, config={"displayModeBar": False}),
            ],
        ),
        dmc.Paper(
            p="md",
            ...
            children=[
                ...
                dmc.ScrollArea(h=500, children=[t_main.render(ctx, theme=theme)]),
            ],
        ),
        dmc.Space(h=50),
    ])
...
def layout():
    ...
    filters = create_filter_section(year_id="route-year", month_id="route-month", additional_filters=ADDITIONAL_FILTERS)
...
data_manager.register_dash_refresh_callbacks(screen_id=SCREEN_ID, body_output_id="ops-routes-body", render_body=_render_ops_routes_body, filter_ids=FILTER_IDS)

register_drawer_callback(drawer_id="route-drawer", widget_registry=WIDGET_REGISTRY, screen_id=SCREEN_ID, filter_ids=FILTER_IDS)
